<?php wp_nav_menu( array('menu' => 'Property Portfolio Nashville Menu' )); ?>
<div class="property-type-list-content property-list-container">
	<?php if ( is_page(1548) ) {  
		...
		<?php if( $the_query->have_posts() ): ?>
			<a href="http://maxtestdomain.com/availability/greater-nashville/<?php echo $url; ?>">Availability Report</a>
			<hr />
			<div class="acf-map">
