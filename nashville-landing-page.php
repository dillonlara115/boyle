<?php
/*
Template Name: Nashville Landing Page
*/
?>
	...
	<div class="property-type-list-content property-list-container">
		...
		<div class="landing-page-bucket-container">
			<div class="bucket">
				...
				<a href="<?php echo get_permalink( 1059 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View All Properties</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Mixed-Use Properties</h4>
				<a href="<?php echo get_permalink( 306 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Mixed-Use Properties</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Office Space</h4>
				<a href="<?php echo get_permalink( 308 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Office Space</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Retail Properties</h4>
				<a href="<?php echo get_permalink( 310 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Retail Properties</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Residential Properties</h4>
				<a href="<?php echo get_permalink( 312 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Residential Properties</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Industrial Properties</h4>
				<a href="<?php echo get_permalink( 314 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Industrial Properties</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Hotels</h4>
				<a href="<?php echo get_permalink( 316 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Hotels</a>
			</div>
			<div class="bucket">
				<h4><?php echo the_title(); ?> Land</h4>
				<a href="<?php echo get_permalink( 318 ); ?>?region=nashville_metro_area" class="Text-Blue-Small">&raquo&nbsp;View Land</a>
			</div>
		</div>
